...
namespace OP_Macro
{
    public partial class Form1 : Form
    {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == 0x0312)
            {
                ...
                else if (m.WParam.ToInt32() == 8)
                {
                    ...
                    {
                        MessageBox.Show("Файлът не съдържа текст!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    RegisterEverything();
                }
        ...
        private void TeleportFunc()
        {
            ...
            {
                MessageBox.Show("Няма избрани координати!");
            }
        }
        ...
        private void TBHours_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Стойността не може да е под 0.");
                TBHours.Text = "0";
            }
        ...
        private void TBMilliseconds_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Стойността не може да е под 1.");
        ...
        private void saveCaptureButton_Click(object sender, EventArgs e)
        {
            if (recordedEvents.Count > 0)
            {
                ...
                MessageBox.Show("Запис записан успешно!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
